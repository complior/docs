...
description: "Standardized AI system identity card — 36 fields, ed25519 signed, 2 generation modes."
---
...
Agent Passport: One Format, Two Sources

Mode 1: AUTO (from code) — AST analysis → 65-70% auto-fill → Developer
Mode 2: RUNTIME (from observation) — MCP Proxy + Eval → 40-70% → DevOps (Planned)

Both produce: agent-manifest.json (36 fields, ed25519 signed)
*/}
...
<CardGroup cols={2}>
  <Card title="2 Generation Modes" icon="wand-magic-sparkles" href="/passport/passport-modes">
  ...
  <Card title="Endpoint Detection" icon="globe" href="/passport/endpoints">
    Auto-detect from .env, Dockerfile, docker-compose, code.
  </Card>
