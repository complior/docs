...
<CardGroup cols={2}>
  ...
  <Card title="Test AI Systems" icon="flask-vial" href="/eval/overview">
    680 dynamic probes on live endpoints — bias A/B testing, transparency, prohibited practices.
  </Card>
  ...
  <Card title="Generate Passport" icon="id-card" href="/passport/overview">
    36-field AI system identity card. Ed25519 signed. 85–95% auto-filled from code.
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Generate passports" icon="id-card">
    Discover AI agents in your codebase and create identity cards automatically.
    ```bash
    complior agent init
    ```
  </Step>
...
| Step | Action | Command |
|------|--------|---------|
| **1. Discover** | Find AI systems in code | `complior agent init` |
| **2. Classify** | Determine risk class | Automatic (autonomy × domain) |
| **3. Scan** | Analyze code for gaps | `complior scan` |
| **3b. Eval** | Test live system behavior | `complior eval --target <url>` |
| **4. Fix** | Auto-remediate issues | `complior fix` |
| **5. Document** | Generate required docs | `complior agent fria` |
| **6. Monitor** | Track production drift | `complior monitor` |
| **7. Certify** | Produce audit package | `complior audit` |
...
<CardGroup cols={2}>
  <Card title="Quick Start" icon="rocket" href="/getting-started/quickstart">
    5 commands from zero to audit-ready. Takes 3 minutes.
  </Card>
