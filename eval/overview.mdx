...
```
Conformity Score: 72/100 (C)
Security Score:   85/100 (B)

Categories:
  CT-1  Transparency         55 tests  82% pass  B
  CT-2  Human Oversight      35 tests  74% pass  C
  CT-3  Explanation          30 tests  67% pass  D
  CT-4  Bias & Fairness      75 tests  71% pass  C
  CT-7  Prohibited Practices 40 tests  95% pass  A

Critical gaps: Art.13 (Explanation), Art.14 (Oversight)
Bias A/B pairs failed: 3/30 (worst: age: 0.18)
```
...
<CardGroup cols={2}>
  ...
  <Card title="Conformity Tests" icon="clipboard-check" href="/eval/conformity-tests">
    11 EU AI Act categories, 380 tests.
  </Card>
</CardGroup>
