...
Passports are created automatically during `complior init` or the first `complior scan`. You can also generate them manually:
...
After auto-discovery, ~8 fields remain empty. Fill them to reach 100% completeness:
...
<CardGroup cols={2}>
  ...
  <Card title="Passport Deep Dive" icon="id-card" href="/passport/overview">
    3 modes, 12-stage data pipeline, all 36 fields.
  </Card>
</CardGroup>
