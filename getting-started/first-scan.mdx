...
| **L4: Code Patterns** | 40+ AST patterns, SDK wrappers, permissions | 0.75 | Bare LLM API call, missing error handling |
| **NHI: Secrets** | 37 secret patterns (API keys, tokens) | — | Exposed API key in source |
| **CROSS: Cross-Layer** | Consistency rules across layers | — | Logging without retention, kill-switch without tests |
